...
<a id='snippet-SqlEnableAttachments'></a>
```cs
...
```
<sup><a href='/src/Attachments.Sql.Tests/Snippets/Usage.cs#L12-L31' title='Snippet source file'>snippet source</a> | <a href='#snippet-SqlEnableAttachments' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<a id='snippet-SqlEnableAttachmentsRecommended'></a>
```cs
configuration.EnableAttachments(
    connectionFactory: OpenConnection,
    timeToKeep: TimeToKeep.Default);
```
<sup><a href='/src/Attachments.Sql.Tests/Snippets/Usage.cs#L33-L39' title='Snippet source file'>snippet source</a> | <a href='#snippet-SqlEnableAttachmentsRecommended' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
...
<a id='snippet-OutgoingFromIncoming'></a>
```cs
...
```
<sup><a href='/src/Attachments.Sql.Tests/Snippets/Outgoing.cs#L86-L109' title='Snippet source file'>snippet source</a> | <a href='#snippet-OutgoingFromIncoming' title='Start of snippet'>anchor</a></sup>
<!-- endSnippet -->
